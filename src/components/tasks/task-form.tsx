...
export function TaskForm({ projectId, members, labels, task }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-600 mb-1.5">タイトル</label>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-600 mb-1.5">優先度</label>
      ...
      <div>
        <label className="block text-sm font-medium text-gray-600 mb-1.5">担当者</label>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-600 mb-1.5">開始日</label>
          <input type="date" {...register("start_date")} className={inputClass} />
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-600 mb-1.5">期限</label>
      ...
      {labels.length > 0 && (
        <div>
          <label className="block text-sm font-medium text-gray-600 mb-1.5">ラベル</label>
